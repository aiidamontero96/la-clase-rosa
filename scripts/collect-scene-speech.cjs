...
for(const file of ['data.js','pdi.js','play-content.js','sheet-studio.js','audio/pdi/manifest.js','pdi-voice.js','aula.js','rosi-config.js','rosi-media.js','rosi-episode.js','rosi-missions.js','classroom.js','pdi-scenes.js','app.js'])vm.runInContext(fs.readFileSync(path.join(dist,file),'utf8'),context,{filename:file});
